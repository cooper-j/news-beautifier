...
public class MyAppWidgetProvider extends AppWidgetProvider {
    public static final String ACTION = "com.github.newsbeautifier.widget.MyAppWidgetProvider.ACTION";
    public static final String EXTRA_ITEM = "com.github.newsbeautifier.widget.MyAppWidgetProvider.EXTRA_ITEM";
